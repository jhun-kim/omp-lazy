...
The OMP-native contract, activation boundary, artifact containment, claim graph, proof requirements, high-risk claim lock, and abstention rules are implemented independently in this package.
