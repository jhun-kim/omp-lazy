...
describe("public loader probe", () => {
  it("loads a valid extension and inventories its registrations", async () => {
    ...
    await writeFile(
      extension,
      'export default function fixture(pi) { pi.registerCommand("fixture-command", { description: "fixture", handler: async () => {} }); pi.on("input", async () => {}) }\n',
    )
  ...
  it("returns nonzero for an import-broken extension", async () => {
