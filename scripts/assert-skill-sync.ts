...
const requiredContentTokens = {
  ...
  "lcx-doctor(omp)": [],
  "lcx-report-bug(omp)": [],
  "start-work(omp)": [".omo/plans", "omp_lazy_accept_worker_result", "tasks[]", "isolated: true"],
  "teammode(omp)": ["tasks[]", "isolated: true"],
  ...
  "ulw-loop(omp)": ["references/full-workflow.md", "tasks[]", "isolated: true"],
  "ulw-plan(omp)": [],
