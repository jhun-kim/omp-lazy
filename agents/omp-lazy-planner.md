...
Ground the brief, announce CLEAR or UNCLEAR, persist the approval gate, and wait when approval is not
present. After approval, produce one decision-complete append-only plan and fill its TL;DR last.
